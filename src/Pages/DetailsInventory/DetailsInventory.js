import { fa8, faCircleMinus, faCoffee, faPerson, faPersonBiking, faPersonWalking, faStore, faStoreAlt, faStoreAltSlash } from '@fortawesome/free-solid-svg-icons';
...
const DetailsInventory = () => {
    ...
    return (
        <div style={{fontFamily:"Aleo"}} id='details'>
            <div className='container gap-5 my-3 d-lg-flex align-items-center justify-content-center'>
                      ...
                      <h4 className='text-center mb-3'>Reduce Stock</h4>
                      <button onClick={handleDelivered} className='btn btn-primary w-100'>Reduce
                      <FontAwesomeIcon  className='ms-3' icon={faCircleMinus}></FontAwesomeIcon>
                      </button>
                      </div>
